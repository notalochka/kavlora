...
export const DICTIONARIES: Record<LocaleCode, AppDictionary> = {
  uk: {
    ...
    advantages: {
      ...
      precisionText:
        "Якщо ви хочете дізнатися більше про нашу продукцію, етапи обробки дуба та виробничі можливості, перегляньте відео нижче.",
  ...
  en: {
    ...
    advantages: {
      ...
      precisionText: "If you want to learn more about our products and production capabilities, watch the video below.",
  ...
  "zh-CN": {
    ...
    advantages: {
      ...
      precisionText: "想了解更多产品与生产能力，可查看视频。",
